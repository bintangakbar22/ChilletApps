      ...
      {({handleChange, handleBlur, handleSubmit, values, errors}) => (
        <View style={styles.Container}>
          ...
          <ScrollView contentContainerStyle={{marginHorizontal:20}}>
            ...
            <Text style={[styles.TextPrice,{paddingVertical:ms(10)}]}>Email : {userData.email}</Text>
            ...
            <View style={styles.Bottom}>
                ...
                {values.city!=''&&values.address!=''&&values.postal!=''&&values.phone!='' &&values.province!=''?
                  <Button style={{width:window.width*0.35,marginTop:0,height:50,backgroundColor:COLORS.green}} caption={'Order'} onPress={handleSubmit}/>
                :

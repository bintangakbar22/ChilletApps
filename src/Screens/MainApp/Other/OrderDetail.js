...
import { 
  ...
  rupiah,
  doneOrder,
  orderSuccess} from '../../../Redux/actions';
...
const OrderDetail = ({route}) => {
  ...
  const uploadImageToServer = () => {
    RNFetchBlob.fetch('POST', URL+'user/order/verify/'+data.id, {
      Authorization: `Bearer ${loginUser.access_token}`,
      otherHeader: "foo",
      'Content-Type': 'multipart/form-data',
    }, [
        { name: 'payment', filename: 'image.png', type: 'image/png', data: dataImage },
      ]).then((resp) => {
        Toast.show({
          type: 'success',
      ...
      {data &&  (
        <SafeAreaView style={styles.Container}>
          ...
          <ScrollView
            ...
            <View style={{margin: ms(25), flexDirection: 'column',marginTop:ms(5)}}>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                ...
                <Text style={[styles.Text, {color:COLORS.green,fontSize:17}]}>
                    Confirmed
                </Text>
                }
                {data.status=='Verifying' &&
                <Text style={[styles.Text, {color:COLORS.red,fontSize:17}]}>
                  Verifying
                </Text>
                 }
                ...
                data.order_items.map(item => {
                 return (
                    <View  style={{flexDirection: 'row', marginTop: 24}}>
                        ...
                        <Image
                            style={styles.image}
                            source={{uri: URLProduct+ item.products.image}}
                        />
                        </View>
                  ...
                  {data.status=='Pending'&&(
                    <>
                     <Text style={[styles.Text, {fontSize: ms(14.5),alignSelf:'flex-end',marginTop:ms(5),color:'orange'}]}>
                  ...
                  {data.status=='Verifying'&&(
                    <>
                     <Text style={[styles.Text, {fontSize: ms(14.5),alignSelf:'flex-end',marginTop:ms(5),color:COLORS.red}]}>
                  ...
                  {data.status=='Success'&&(
                    <>
                     <Text style={[styles.Text, {fontSize: ms(14.5),alignSelf:'flex-end',marginTop:ms(5),color:COLORS.green}]}>
                  ...
                  <>
                    <Text style={[styles.textBlack, {fontSize:15,fontFamily:FONTS.Bold}]}>
                      {userData.name}
                    </Text>
                  ...
                  {data.status=='Confirmed' &&(
                    <>
                    <Text style={[styles.Text, {fontSize: 16,alignSelf:'flex-start',marginTop:ms(5),color:COLORS.red}]}>
                    Please Make Payment within 1 x 24 hours
                    </Text>
                    <Text style={[styles.Text, {fontSize:20,paddingTop:ms(5)}]}>
                        Mandiri
                    </Text>
                    <Text style={[styles.textBlack, {fontSize:15}]}>
                        1330015378144
          ...
          <BottomModal onDismiss={onDismiss}>
           <View style={{width:window.width,height:ms(440)}}>
              <Text style={[styles.Text, {fontSize: ms(23),alignSelf:'center',fontFamily:FONTS.Bold}]}>
                Your Payment Proof
              </Text>
              <Image   
                ...
                style={{
                  ...
                  borderWidth:ms(2),
                  borderRadius:ms(10),marginTop:ms(15)}}  />
              <View style={{flexDirection:'row',justifyContent:'center',marginTop:ms(10)}}> 
                <Button
          ...
          {  data.status=='Sending'&&
            <Button
              ...
              onPress={() => {
                dispatch(orderSuccess(loginUser.access_token,data.id))
                  .then(()=>{
                    navigation.navigate("Orders")
                  })
              }}
